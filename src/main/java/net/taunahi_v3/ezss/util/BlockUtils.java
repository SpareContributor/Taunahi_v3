package net.taunahi_v3.ezss.util;
...
public class BlockUtils {
    ...
    public static boolean isCropReady(int xOffset) {
        ...
        List<BlockPos> crops;
        if (MacroHandler.getInstance().getCrop() == TaunahiConfig.CropEnum.CACTUS || MacroHandler.getInstance().getCrop() == TaunahiConfig.CropEnum.SUGAR_CANE) {
        ...
        } else if (TaunahiConfig.getMacro() == TaunahiConfig.MacroEnum.S_CACTUS_SUNTZU || MacroHandler.getInstance().getCrop() == TaunahiConfig.CropEnum.COCOA_BEANS) {
            crops = Arrays.asList(
                    getRelativeBlockPos(xOffset, 2, 1, yaw),
                    getRelativeBlockPos(xOffset, 3, 1, yaw)
            );
        } else if (TaunahiConfig.getMacro() == TaunahiConfig.MacroEnum.S_MUSHROOM || TaunahiConfig.getMacro() == TaunahiConfig.MacroEnum.S_MUSHROOM_ROTATE) {
            crops = Arrays.asList(
