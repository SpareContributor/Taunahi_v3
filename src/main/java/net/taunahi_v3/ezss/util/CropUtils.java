...
import net.taunahi.ezskyblockscripts.mixin.block.IBlockAccessor;
...
public class CropUtils {
    ...
    public static void updateCropsMaxY(World world, BlockPos pos, Block block) {
        ...
        if (TaunahiConfig.increasedCrops)
            accessor.setMaxY(
    ...
    public static void updateWartMaxY(World world, BlockPos pos, Block block) {
        if (TaunahiConfig.increasedNetherWarts)
    ...
    public static void updateCocoaBeansHitbox(IBlockState blockState) {
        ...
        if (TaunahiConfig.increasedCocoaBeans) {
            switch (enumFacing) {
                case SOUTH: {
